...
from core import universitybot
...
from .events.custom_commands_service import CustomCommandsService
...
from .events.server_stats import ServerStats

########-------HELP-------########
from .universitybot.antinuke import _antinuke
from .universitybot.extra import _extra
from .universitybot.general import _general
from .universitybot.automod import _automod 
from .universitybot.moderation import _moderation
#from .universitybot.inviteTracker import _inviteTracker
from .universitybot.music import _music
from .universitybot.fun import _fun
from .universitybot.games import _games
from .universitybot.ignore import _ignore
...
from .universitybot.vanity import _vanity
from .universitybot.inviteTracker import inviteTracker 
from .universitybot.counting import _Counting
from .universitybot.j2c import _J2C
from .universitybot.ai import _ai
from .universitybot.booster import __boost 
...
async def setup(bot: universitybot):
  ...
  await bot.add_cog(CustomCommandsService(bot))
