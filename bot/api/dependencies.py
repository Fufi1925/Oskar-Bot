...
_bot_instance: Optional["universitybot"] = None
...
def set_bot(bot_instance: "universitybot"):
    """
    Sets the global bot instance. 
    This should be called in UniversityBot.py during startup.
    """
    global _bot_instance
    _bot_instance = bot_instance

def get_bot() -> "universitybot":
    """
    FastAPI dependency to retrieve the Discord bot instance.
    Usage: bot: universitybot = Depends(get_bot)
    """
