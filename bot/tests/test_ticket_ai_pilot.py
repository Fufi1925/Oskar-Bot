...
check("HTTP 400 retries without optional model parameters", "response.status_code == 400" in AI and 'json={"model": model, "messages": messages, "stream": False}' in AI and "_groq_error(response)" in AI)
