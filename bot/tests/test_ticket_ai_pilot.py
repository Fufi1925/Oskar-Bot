...
check("missing prerequisites explain instead of silently disabling", "Lade zuerst eine .txt-Wissensdatei hoch" in PANEL and "XAI_TICKET_AI_KEY fehlt noch" in PANEL)
