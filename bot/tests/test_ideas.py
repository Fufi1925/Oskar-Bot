...
check("Einreichung, Details und Belohnungen haben eigene neue Ansichten",all(x in ui for x in ["Ein Problem pro Idee", "Antwort vom University Bot Team", "Für diesen Server einlösen"]))
