...
check("Owner-Verwaltung hat Status, Belohnung, Blacklist und Löschen",all(x in ui for x in ["Annehmen + Belohnung","Nutzer sperren","Sperre entfernen","Idee endgültig löschen?"]))
