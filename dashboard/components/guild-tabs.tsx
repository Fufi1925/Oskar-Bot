...
export function GuildTabs({ guildId }: { guildId: string }) {
  ...
  const tabs: Tab[] = [
    { name: "Übersicht", href: `/dashboard/guild/${guildId}`, icon: Layers },
    { name: "Anti-Nuke", href: `/dashboard/guild/${guildId}/antinuke`, icon: Sword },
    { name: t("automod"), href: `/dashboard/guild/${guildId}/automod`, icon: ShieldCheck },
    { name: t("tickets"), href: `/dashboard/guild/${guildId}/tickets`, icon: Ticket },
    { name: "Verifizierung", href: `/dashboard/guild/${guildId}/verification`, icon: Shield },
    { name: "Begrüßung", href: `/dashboard/guild/${guildId}/welcome`, icon: SmilePlus },
    { name: "Einladungen", href: `/dashboard/guild/${guildId}/invites`, icon: LinkIcon },
    { name: "Auto Role", href: `/dashboard/guild/${guildId}/autorole`, icon: Bot },
    { name: "Reaktions-Rollen", href: `/dashboard/guild/${guildId}/reactionroles`, icon: Activity },
    { name: "Join to Create", href: `/dashboard/guild/${guildId}/j2c`, icon: Mic },
    { name: "Sprach-Rolle", href: `/dashboard/guild/${guildId}/invcrole`, icon: Volume2 },
    { name: "Vanity-Rollen", href: `/dashboard/guild/${guildId}/vanityroles`, icon: Link2 },
    ...
    { name: "Booster", href: `/dashboard/guild/${guildId}/booster`, icon: Gem },
