...
export const MetricCard = ({ 
  ...
  return (
    <div className={cn(
      "bg-[#131318] border border-slate-800 p-6 rounded-3xl relative overflow-hidden group hover:border-primary/50 transition-all shadow-xl hover:shadow-primary/5 shadow-black/20",
      className
    )}>
