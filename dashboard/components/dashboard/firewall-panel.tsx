...
export function FirewallPanel() {
  ...
  const acknowledge = async (event:Event) => {
    setBusy(true);
    try { await api.acknowledgeFirewallIncident(event.id); toast.success("Alarm geschlossen – niemand wurde gesperrt."); await load(true); }
