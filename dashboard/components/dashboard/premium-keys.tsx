...
/**
 * Lizenz-Keys — die Verwaltung.
 *
 * Hiess frueher `PremiumAdmin` und war DER Premium-Reiter. Seit der
 * Zusammenlegung ist Premium kontobasiert und kommt aus dem
 * Beta-Antrag; neue Keys werden nicht mehr ausgegeben. Bestehende
 * muessen aber sperrbar und einsehbar bleiben — deshalb lebt dieser
 * Teil weiter, nur eine Ebene tiefer: im neuen Reiter unter einem
 * Abschnitt, den man aufklappt.
 *
 * Was das Layout traegt:
 *
 *   * Die Liste ist der Kern. Alles andere ist eine Zahl darueber
 *     oder ein Formular, das man oeffnet.
 *   * Jedes Feld der API ist erreichbar. Daten und Hash stehen in
 *     einer Zeile, die man aufklappt.
 *   * Mengen-Arbeit laeuft ueber Auswahl, nicht ueber fuenfzig
 *     Bestaetigungen.
