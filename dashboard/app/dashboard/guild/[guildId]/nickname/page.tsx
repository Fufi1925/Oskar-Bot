...
export default function NicknamePage({ params }: { params: { guildId: string } }) {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
      ...
      <section className="bg-[#131318] border border-slate-800 rounded-3xl p-8 space-y-6 shadow-xl">
      ...
      <section className="bg-[#131318] border border-slate-800 rounded-3xl overflow-hidden shadow-xl">
