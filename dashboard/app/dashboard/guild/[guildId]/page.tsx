...
export default function GuildOverviewPage({ params }: { params: { guildId: string } }) {
  const modules = [
    { title: "Auto Moderation", desc: "Anti-spam, bad words, and links protection.", icon: ShieldCheck, status: "Aktiv" },
    { title: "Ticket System", desc: "Helpdesk for user support and inquiries.", icon: Ticket, status: "Configured" },
    { title: "Leveling", desc: "Gamify your community with XP and ranks.", icon: BarChart4, status: "Aktiv" },
    { title: "Event Logging", desc: "Detailed audit logs for every server event.", icon: FileText, status: "Aktiv" },
  ];
      ...
      <div className="space-y-8">
        <section>
          <div className="flex items-center gap-2 mb-6">
            <h2 className="text-xl font-bold text-white tracking-tight">Aktiv Modules</h2>
