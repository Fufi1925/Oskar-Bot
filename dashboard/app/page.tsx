      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/[0.03] bg-[#020617]/80 backdrop-blur-3xl transition-all duration-500">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-10 text-[11px] font-black uppercase tracking-widest text-slate-500">
            <Link href="#features" className="hover:text-red-500 transition-colors">Funktionen</Link>
            <Link href="#architecture" className="hover:text-red-500 transition-colors">Architektur</Link>
            <Link href="#modules" className="hover:text-red-500 transition-colors">Module</Link>
            <Link href="#network" className="hover:text-red-500 transition-colors">Netzwerk</Link>
          </div>
      ...
      <header className="relative z-10 pt-56 pb-32 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-6xl sm:text-8xl md:text-[10rem] font-bold text-white tracking-tighter leading-[0.8] mb-12 font-outfit animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-100 uppercase">
            Evolution <br />
            <span className="bg-gradient-to-r from-red-500 via-red-400 to-orange-500 bg-clip-text text-transparent italic font-black">Moderiert.</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
           <div className="flex flex-col lg:flex-row items-center gap-24">
              <div className="flex-1 space-y-12">
                 <h2 className="text-6xl md:text-8xl font-bold text-white tracking-tighter font-outfit uppercase">Weltweit <br /><span className="text-red-500">Erreichbar.</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-32">
            ...
            <div className="space-y-8">
               ...
               <ul className="space-y-5 text-[11px] font-black uppercase tracking-widest text-slate-500">
                  ...
                  <li><Link href="/docs" className="hover:text-red-500 transition-colors">Dokumentation</Link></li>
                  <li><Link href="#" className="hover:text-red-500 transition-colors">API-Referenz</Link></li>
               </ul>
            </div>
            <div className="space-y-8">
               <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-white opacity-40">Identity</h4>
               <ul className="space-y-5 text-[11px] font-black uppercase tracking-widest text-slate-500">
                  <li><Link href="/privacy" className="hover:text-red-500 transition-colors">Datenschutz</Link></li>
                  <li><Link href="/terms" className="hover:text-red-500 transition-colors">Nutzungsbedingungen</Link></li>
