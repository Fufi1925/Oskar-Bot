...
| `GOOGLE_API_TICKET_KEY` | Separater Gemini-Key für den privaten KI-Ticketassistenten | Optional/Pilot |
| `GOOGLE_TICKET_AI_MODEL` | Gemini-Modell für Ticket-Antworten, Standard `gemini-2.0-flash` | Optional |
| `API_ENABLED` | `true` | ✅ |
